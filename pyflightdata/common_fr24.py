...
def get_aircraft_data(url):
    ...
    image_data = get_raw_aircraft_image_data(url)
    return process_raw_aircraft_info_data(info_data, image_data)
...
def process_raw_aircraft_info_data(data, image_data):
    result = []
    record = {}
    images = []
    for item in data:
